...
for i in range(10):
    ...
    # Calculating time taken by 4 overlapping writes.
    starttime = time.time()
    client1.write(int(0/4 * (4096 * i)), client_buf1)
    client1.write(int(1/4 * (4096 * i)), client_buf2)
    client1.write(int(2/4 * (4096 * i)), client_buf3)
    client1.write(int(3/4 * (4096 * i)), client_buf4)
